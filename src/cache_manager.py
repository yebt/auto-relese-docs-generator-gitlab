...
class CacheManager:
    ...
    def save_commits_cache(self, from_tag: str, to_tag: str, commits: List[Any]) -> None:
    ...
    def save_commit_detail(self, from_tag: str, to_tag: str, commit_id: str, detail: Dict) -> None:
